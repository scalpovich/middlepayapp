...
public class DayTradeDetailService {
	 ...
	 * @param response
	 */
	public void DayTradeDetail(LoginUser user , RequestData request ,  ResponseData response){
		...
		List<Map<String,String>> tradelist = PayOrderDAO.DayTradeDetail(new Object[]{userID , tradeDate});
	 ...
	 * @param response
	 */
	public void DayTradeLineChart(LoginUser user , RequestData request ,  ResponseData response){
		String tradeDate = request.getTradeDate();
		...
		try {
            ...
            List<Map<String,String>> list = PayOrderDAO.DayTradeLineChart(new Object[]{user.getID() , startTime , tradeDate});
            ...
            if(tradeDate.equals(DateUtil.getNowTime(DateUtil.yyyyMMdd))){
            	...
            	Map<String,String> todayTrade = PayOrderDAO.ToDayTradeLineChart(new Object[]{tradeDate , user.getID() , tradeDate});
            	Map<String,String> map = new HashMap<String,String>();
            	...
            	Map<String,String> todayTrade = PayOrderDAO.DayTradeTotalData(new Object[]{ user.getID() , tradeDate});
