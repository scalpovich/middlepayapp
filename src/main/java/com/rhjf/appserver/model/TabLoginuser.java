...
public class TabLoginuser {
	...
	private String merchantTypeValue;
	...
	public void setMerchantLeve(int merchantLeve){
		this.merchantLeve = merchantLeve;
	}
	public int getMerchantLeve(){
		return merchantLeve;
	}
