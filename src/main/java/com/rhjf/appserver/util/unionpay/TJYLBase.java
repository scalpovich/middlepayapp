package com.rhjf.appserver.util.unionpay;
...
public class TJYLBase {
	...
	public static String tjyl_confirmSignCert = "/usr/local/unionpay.cer";
	...
	public static Map<String, String> submitDate(Map<String, ?> contentData, String requestUrl, String signCert, String password) {
		...
		logger.info("Request to unionpay [" + requestUrl + "]" + submitFromData.toString());
		...
		try {
			...
			logger.info("Respone from  unionpay [" + requestUrl + "]" + resultString);
