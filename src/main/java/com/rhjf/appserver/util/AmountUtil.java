...
/**
 * Title: 金额 工具类 Description: Copyright: Copyright (c)2011 Company: pay
 * 
...
public class AmountUtil implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2720883037715291117L;
	 ...
	 * @param int
	 *            scale 保留的小数位
	 * @return double example: 1.7333 处理后： 1.74 1.7699 处理后： 1.77 1.3000 处理后：
	 *         1.30
	 */
